...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002078545756') #support group id ex:  -1002936246860
...
URL = environ.get("URL", "https://v4-qkdy.onrender.com") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
