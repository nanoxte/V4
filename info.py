...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7188145451:AAE-vCyAwMtv6SlEAFIOmjZwYv7FJtPIrgQ') #bot token from botfather
if len(BOT_TOKEN) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002066690151').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002066690151').split()]
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002066690151') #support group id ex:  -1002936246860
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002072099903") #if is_stream = true then add a channel id ex: -10026393639
